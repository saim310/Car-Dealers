...
export default function AllProducts({ badgeFilter }: AllProductsProps) {
    ...
    const filteredProducts = useMemo(() => {
        ...
        // Badge / Hot Deal filter (checks status === "sale", badge, or isHotDeal flags)
                ...
                <div style={{ marginBottom: '20px' }}>
                    ...
                    <nav style={{ fontSize: '13px', color: '#888' }}>
                        ...
                        <span style={{ color: '#1a1a2e', fontWeight: 700 }}>
                            ...
                            {badgeFilter ? `${badgeFilter}s` : 'All Cars'}
